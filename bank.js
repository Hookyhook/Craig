...
exports.deposit = async(interaction) => {
    ...
    if(balance<deposit){
        ...
        await interaction.reply({embeds: [errEmbed.setDescription("You dont have that much money on hand! DO you want to deposit all?")],components:[button]});
...
exports.withdraw = async(interaction) => {
    ...
    interaction.reply("not finisched atm?");
